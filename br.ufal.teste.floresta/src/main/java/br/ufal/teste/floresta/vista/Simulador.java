package br.ufal.teste.floresta.vista;

import br.ufal.teste.floresta.*;
...
//			c.mover();
	...
	protected synchronized void paintComponent(Graphics g){
		...
		if(inicioSimulador)
		{
			...
			g.drawString("UFAL >> 2017 >> C. Computa��o.", 130, 190);
			g.setColor(Color.CYAN);			
			g.drawString("1.Para iniciar defina \"Popula��o Inicial\".", 130, 30);
			g.drawString("2.Defina \"Vegeta��o Inicial\".", 130, 45);
			g.drawString("3.Clique em \"Configura��o\".", 130, 60);
			g.drawString("(A anima��o estar� no seu estado inicial.)", 130, 75);
			g.drawString("4.Clique em \"Iniciar\".", 130, 90);
			g.drawString("(Ao terminar a aplica��o um ficheiro \"log.txt\"", 130, 120);
			g.drawString("será gravado no mesmo directório que a aplicação.)", 130, 135);
			g.drawString("(PROJECTO DE TESTE DE SOFTWARE)", 180, 215);
